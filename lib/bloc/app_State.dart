...
class AppStateLoggedOut extends AppState {
  const AppStateLoggedOut({required super.isLoading, required super.authError});
  @override
  String toString() {
...
class AppStateIsInRegistrationView extends AppState{
  AppStateIsInRegistrationView({required super.isLoading, required super.authError});
}
