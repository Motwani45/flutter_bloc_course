...
@immutable
class AppEventGotToRegistration implements AppEvent{
  const AppEventGotToRegistration();
}
@immutable
class AppEventGotToLogin implements AppEvent{
  const AppEventGotToLogin();
}
@immutable
